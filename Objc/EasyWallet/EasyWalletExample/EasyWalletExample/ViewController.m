...
- (IBAction)startEasyWallet:(id)sender {
    TPDEasyWallet * easyWallet = [TPDEasyWallet setupWithReturUrl:@"Your universal link"];
    [[[easyWallet onSuccessCallback:^(NSString * _Nullable prime) {
